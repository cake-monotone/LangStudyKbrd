...
public class ColorPicker extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color) {
            ...
            mPaint.setStrokeWidth(32*4);//원통 두께
        ...
        private static final int CENTER_X = 100*3;
        private static final int CENTER_Y = 100*3;
        private static final int CENTER_RADIUS = 32*4;
